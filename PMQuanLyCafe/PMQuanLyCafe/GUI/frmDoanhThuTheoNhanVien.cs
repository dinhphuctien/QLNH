...
namespace PMQuanLyCafe.GUI
{
    public partial class frmDoanhThuTheoNhanVien : Form
    {
        ...
        {
            dtgv.DataSource = db.ThongKeDoanhThuTheoNhanVien(dt1.Value.ToString("yyyyMMdd"), dt2.Value.ToString("yyyyMMdd"));
            ...
            dtgv.Columns[4].HeaderText = "Thành tiền";
            TongTien();
        }
        ...
        private void btnIn_Click(object sender, EventArgs e)
        {
            ...
            dtIn = db.ThongKeDoanhThuTheoNhanVien(dt1.Value.ToString("yyyyMMdd"), dt2.Value.ToString("yyyyMMdd"));
            tongtien = lblTongTien.Text;
            frmInDoanhThuTheoNhanVien frm = new frmInDoanhThuTheoNhanVien();
            frm.ShowDialog();
        }
    }
}
