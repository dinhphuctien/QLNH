...
namespace PMQuanLyCafe.GUI
{
    public partial class frmLoaiDoUong : Form
    {
        ...
        private void GetAll()
        {
            ...
            dtgv.Columns[0].HeaderText = "Mã loại";
            dtgv.Columns[1].HeaderText = "Tên loại";
        ...
        {
            save = true;
            frmLoaiDoUong2 frm = new frmLoaiDoUong2();
            frm.Text = "Thêm mới loại đồ uống";
            frm.ShowDialog();
            GetAll();
        }
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            save = false;
            frmLoaiDoUong2 frm = new frmLoaiDoUong2();
            frm.txtMaDanhMuc.Text = row.Cells[0].Value.ToString();
            frm.txtTenDanhMuc.Text = row.Cells[1].Value.ToString();
            frm.Text = "Sửa thông tin loại đồ uống";
            frm.ShowDialog();
            GetAll();
        }
