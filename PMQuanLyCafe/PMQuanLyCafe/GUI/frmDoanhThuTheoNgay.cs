...
namespace PMQuanLyCafe.GUI
{
    public partial class frmDoanhThuTheoNgay : Form
    {
        ...
        {
            dtgv.DataSource = db.ThongKeDoanhThuTheoNgay(dt1.Value.ToString("yyyyMMdd"), dt2.Value.ToString("yyyyMMdd"));
            frmMain.SetupDataGridView(dtgv);
            dtgv.Columns[0].HeaderText = "STT";
            dtgv.Columns[1].HeaderText = "Ngày thanh toán";
            dtgv.Columns[2].HeaderText = "Số lượng";
            dtgv.Columns[3].HeaderText = "Tổng tiền";
            TongTien();
        }
        ...
        private void btnIn_Click(object sender, EventArgs e)
        {
            ...
            dtIn = db.ThongKeDoanhThuTheoNgay(dt1.Value.ToString("yyyyMMdd"), dt2.Value.ToString("yyyyMMdd"));
            tongtien = lblTongTien.Text;
            frmInDoanhThuTheoNgay frm = new frmInDoanhThuTheoNgay();
            frm.ShowDialog();
        }
    }
}
