...
namespace PMQuanLyCafe.GUI
{
    public partial class frmBan : Form
    {
        ...
        private void GetAll()
        {
            ...
            dtgv.Columns[0].HeaderText = "Số bàn";
            dtgv.Columns[1].HeaderText = "Tên bàn";
            dtgv.Columns[2].HeaderText = "Vị trí";
            dtgv.Columns[3].HeaderText = "Trạng thái";
            frmMain.SetupDataGridView(dtgv);
        }
        private void btnThem_Click(object sender, EventArgs e)
        {
            save = true;
            frmBan2 frm = new frmBan2();
            frm.Text = "Thêm mới bàn";
            frm.ShowDialog();
            GetAll();
        }
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            save = false;
            frmBan2 frm = new frmBan2();
            frm.txtSoBan.Text = row.Cells[0].Value.ToString();
            frm.txtTenBan.Text = row.Cells[1].Value.ToString();
            ViTri = row.Cells[2].Value.ToString();
            TrangThai = row.Cells[3].Value.ToString();
            frm.Text = "Sửa thông tin bàn";
            frm.ShowDialog();
            GetAll();
        }
