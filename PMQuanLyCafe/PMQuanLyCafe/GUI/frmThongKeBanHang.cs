...
namespace PMQuanLyCafe.GUI
{
    public partial class frmThongKeBanHang : Form
    {
        ...
        {
            dtgv.DataSource = db.ThongKeBanHang(dt1.Value.ToString("yyyyMMdd"), dt2.Value.ToString("yyyyMMdd"));
            ...
            dtgv.Columns[3].HeaderText = "Tên đồ uống";
        ...
        private void btnIn_Click(object sender, EventArgs e)
        {
            ...
            dtIn = db.ThongKeBanHang(dt1.Value.ToString("yyyyMMdd"), dt2.Value.ToString("yyyyMMdd"));
            tongtien = lblTongTien.Text;
            frmInThongKeBanHang frm = new frmInThongKeBanHang();
            frm.ShowDialog();
        }
    }
}
